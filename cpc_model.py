...
class PlanetEncoder(nn.Module):
    ...
    def __init__(self, z_dim, channel_dim, **kwargs):
        super().__init__()
        self.conv1 = nn.Conv2d(channel_dim, 32, 4, stride=2)
...
class PlanetTransition(nn.Module):
    prefix = 'transition'

    def __init__(self, z_dim, action_dim, **kwargs):
        super().__init__()
        hidden_size = 200
        self.fc1 = nn.Linear(z_dim + action_dim, hidden_size)
